  ...
  <div class="bg-white border-t border-gray-100">
    ...
    <div class="flex items-center space-x-1 px-2 py-1">
      <textarea
        ...
        class="flex-1 py-2 px-1 bg-transparent border-none focus:outline-none focus:ring-1 focus:ring-blue-400 resize-none disabled:bg-gray-100 disabled:cursor-not-allowed transition duration-150 ease-in-out text-base"
